...
export const ConfirmMessage: FC<ConfirmMessageProps> = ({ isOpen, onClose, messageOne, messageTwo, confirmed }) => {
 
  return (
    <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 z-20
        " onClose={onClose}>
            <Transition.Child
                as={Fragment}
                    ...
                    >
                        <Dialog.Panel className="relative w-[250px] transform overflow-hidden rounded-2xl bg-[#171720]  p-3 text-left align-middle shadow-xl h-[150px] transition-all flex items-center">
                            <div className="flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-center w-full text-xs mt-3 mb-2">{messageOne}</p>
                                    <p className="text-center w-full text-[0.7rem] opacity-80 mb-2">{messageTwo}</p>
