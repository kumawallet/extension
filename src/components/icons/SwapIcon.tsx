export const SwapIcon  = ({ className = "", color = "white" , size = "24"}) =>  (
        ...
        <path d="M18.41 22.0003H21C21.55 22.0003 22 21.5503 22 21.0003V18.4103C22 17.5203 20.92 17.0703 20.29 17.7003L17.7 20.2903C17.08 20.9203 17.52 22.0003 18.41 22.0003Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
